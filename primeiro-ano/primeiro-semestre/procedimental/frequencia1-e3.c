/* O seguinte programa lê N valores para um vetor e apresenta ao utilizador um menu que
permite escolher entre as operações de soma e média (com outra qualquer opção sai). */
